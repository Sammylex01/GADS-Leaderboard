...
import com.example.gadsleaderboard.viewmodel.LearningLeadersViewModel;
...
public class LearningLeadersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final LearningLeadersAdapter adapter = new LearningLeadersAdapter(getContext());
        ...
        viewModel.getLearningLeaders()
                .observe(this, new Observer<List<LearningLeader>>() {
                    ...
                    public void onChanged(List<LearningLeader> learningLeaders) {
                        adapter.setLearningLeaderList(learningLeaders);
